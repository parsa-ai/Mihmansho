function openWinTab() {
    ...
    'شماره موبایل فقط یک شانس اولیه دارد.',
    'جایزه اصلی شامل یک شب اقامت رایگان در اقامتگاه‌های منتخب ماسال، کردان یا رامسر است.',
    'تاریخ و اقامتگاه جایزه اصلی بر اساس ظرفیت و هماهنگی با میهمان‌شو تعیین می‌شود.',
    'شب‌های اضافه، نفر اضافه و هزینه‌های جانبی شامل جایزه اصلی نیستند.',
    'برای دریافت شانس مجدد، لینک دعوت خود را برای دوستانتان ارسال کنید. فقط ثبت‌نام جدید کاربران معتبر محسوب می‌شود و اگر شماره موبایل از قبل در دیتابیس میهمان‌شو وجود داشته باشد، ثبت‌نام جدید محسوب نخواهد شد.',
    'جوایز قابل تبدیل به وجه نقد نیستند.',
    'کدهای تخفیف قابل استفاده در درگاه قسطی نیستند.',
];
